...
public class SlaveDatabaseProperties implements DatabaseProperties{
	...
	private String databaseUrl = "db.data.url";
	private String databaseUsername = "db.data.username";
	private String databasePassword = "db.data.password";
	private String databaseMod = "log4jdbc.use";
	private String databaseUrlLog4 = "db.data.url.log4jdbc";
