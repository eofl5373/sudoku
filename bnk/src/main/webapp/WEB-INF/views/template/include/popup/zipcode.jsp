			...
			<div class="box" id="searchResultBox">
				...
				<table class="tbls1" style="border:0;border-spacing:0;border-collapse:collapse;">
					...
					<tbody id="searchResultArea">
						<!-- <tr><td colspan="2">검색어를 입력해주십시오.</td></tr> --> <!-- 검색어 미입력시 노출 -->
						<!-- <tr><td colspan="2">검색결과가 없습니다. 다시 검색어를 입력해 주십시오.</td></tr> --> <!-- 검색결과 없을시 노출 -->
...
var ZipAPI = {
				...
				, success : function(data, textStatus, jqXHR){
					...
					if(data.statusCode == 1){
						...
						if(!!result && result.length != 0){
							...
							if(
									data.data.NewAddressListResponse.cmmMsgHeader.totalPage == 1
									|| 
		...
		printMsg: function(msg){
			$('#searchResultArea').append($('<tr/>').addClass('resultItem')
					.append($('<td/>').attr('colspan','2').text(msg)));
		},
